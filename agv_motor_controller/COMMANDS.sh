...
echo ""
echo "TERMINAL 3 - Send Test Query (A1 to D3):"
echo "source ~/warehouse_ws/install/setup.bash && ros2 topic pub --once /path_query std_msgs/msg/String \"{data: '{\\\"start\\\":\\\"A1\\\",\\\"goal\\\":\\\"D3\\\"}'}\""
echo ""
echo "TERMINAL 4 - Send Other Queries:"
echo "B2 to HOME-3:"
echo "source ~/warehouse_ws/install/setup.bash && ros2 topic pub --once /path_query std_msgs/msg/String \"{data: '{\\\"start\\\":\\\"B2\\\",\\\"goal\\\":\\\"HOME-3\\\"}'}\""
echo ""
echo "C3 to DOC-BC3:"
echo "source ~/warehouse_ws/install/setup.bash && ros2 topic pub --once /path_query std_msgs/msg/String \"{data: '{\\\"start\\\":\\\"C3\\\",\\\"goal\\\":\\\"DOC-BC3\\\"}'}\""
echo ""
