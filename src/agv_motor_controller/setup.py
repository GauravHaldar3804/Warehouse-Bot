...
setup(
    ...
    install_requires=['setuptools', 'adafruit-circuitpython-mpu6050', 'adafruit-circuitpython-busdevice', 'adafruit-circuitpython-register', 'adafruit-circuitpython-vl53l0x', 'adafruit-circuitpython-ads1x15', 'adafruit-circuitpython-pca9685'],
    zip_safe=True,
    maintainer='gaurav',
